...
namespace pandora_vision
{
  ...
  **/
  void Predator::getGeneralParams()
  {
    ...
    if (_nh.getParam("predator/predator_alert", param))
    {
      _predatorPublisher =
    ...
    if( _nh.getParam("predator/learning_enabled", learningEnabled))
    ...
    if (_nh.getParam("predator/image_height", frameHeight))
    ...
    if (_nh.getParam("predator/image_width", frameWidth))
    ...
    if ( _nh.getParam("predator/hfov", hfov))
    ...
    if (_nh.getParam("predator/vfov", vfov))
    ...
    if (_nh.getParam("predator/input_image_topic", imageTopic))
    ...
    if (_nh.getParam("predator/variance_filter", param_bool_temp))
    {
    ...
    if (_nh.getParam("predator/ensemble_classifier", param_bool_temp))
    {
    ...
    if (_nh.getParam("predator/nn_classifier", param_bool_temp))
    {
    ...
    if (_nh.getParam("predator/use_shift", param_bool_temp))
    {
    ...
    if (_nh.getParam("predator/shift", param_double_temp))
    {
    ...
    if (_nh.getParam("predator/min_scale", param_int_temp))
    {
    ...
    if (_nh.getParam("predator/max_scale", param_int_temp))
    {
    ...
    if (_nh.getParam("predator/min_size", param_int_temp))
    {
    ...
    if (_nh.getParam("predator/num_trees", param_int_temp))
    {
    ...
    if (_nh.getParam("predator/num_features", param_int_temp))
    {
    ...
    if (_nh.getParam("predator/theta_TP", param_double_temp))
    {
    ...
    if (_nh.getParam("predator/theta_FP", param_double_temp))
    {
  ...
  **/
    ...
    const uint32_t& level)
  {
    ...
    ROS_INFO_STREAM("Debug image ok");
  }
}
